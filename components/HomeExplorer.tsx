...
// Shared home/search experience. `variant="parents"` renders a locked-down,
  ...
  return (
    <main className="mx-auto max-w-4xl px-4 pb-16 pt-4">
      ...
      <div className="flex items-center justify-between">
        <a href={homeHref} aria-label="Dream Neighborhood - home" className="rounded-lg outline-none focus-visible:ring-2 focus-visible:ring-brand-500">
          <Logo />
        </a>
        <SettingsMenu
      ...
      {/* Footer - matches dreamneighborhood.com. On the parents-only view the
