...
export function AppShell({
  ...
  active: "home" | "edit" | "help" | "owner" | "account" | "contact" | "upgradeRequests" | "server";
    ...
    <div className="flex min-h-screen flex-col bg-slate-100 md:flex-row">
      ...
      <aside className="flex shrink-0 flex-col bg-[#0b4a3d] p-4 text-white md:min-h-screen md:w-60">
            ...
            return (
              <>
                ...
                <div className="min-w-0">
                  ...
                  <div className="text-[10px] font-semibold tracking-wide text-white/45">
                    {me.isOwner ? "Admin" : me.isPartner ? "Partner" : "Realtor Account"}
                  </div>
                </div>
              </>
            );
        ...
        <nav className="mt-5 space-y-1">
          ...
          {me.isOwner && link("server", "Server Management", "/server")}
        </nav>
